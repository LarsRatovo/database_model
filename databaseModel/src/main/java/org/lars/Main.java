...
//        t.job=1;
        t.transfer_date=Date.valueOf("2012-12-01");
        Transfer t1=new Transfer();
//        t1.job=2;
        t1.transfer_date=Date.valueOf("2012-12-01");
        Transfer t2=new Transfer();
//        t2.job=3;
        t2.transfer_date=Date.valueOf("2012-12-01");
        Transfer t3=new Transfer();
//        t3.job=1;
        t3.transfer_date=Date.valueOf("2012-12-01");
